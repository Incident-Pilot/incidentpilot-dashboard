...
export function SourceStatusDot({
  ...
  return (
    <div className="flex items-center gap-2.5 rounded-lg border border-border bg-surface-2 px-3 py-2.5 shadow-card">
      <span className={`h-2 w-2 shrink-0 rounded-full ${DOT_STYLES[status]}`} aria-hidden />
